# Generated by Django 3.2.5 on 2024-03-20 22:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bdd', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='score_diagnostic', to='DataGuardianApp.basededonnees')),
            ],
        ),
        migrations.CreateModel(
            name='Projet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_doublons', models.IntegerField(blank=True, default=None, null=True)),
                ('nombre_similaires', models.IntegerField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_ligne', models.IntegerField(blank=True, null=True)),
                ('nom_colonne', models.CharField(max_length=100)),
                ('valeur', models.CharField(blank=True, max_length=1000, null=True)),
                ('anomalie', models.CharField(blank=True, max_length=100, null=True)),
                ('type_colonne', models.CharField(blank=True, max_length=100, null=True)),
                ('commentaire', models.CharField(blank=True, max_length=100, null=True)),
                ('code_correction', models.CharField(blank=True, max_length=100, null=True)),
                ('diagnostic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='diagnostic_detail', to='DataGuardianApp.diagnostic')),
            ],
        ),
        migrations.AddField(
