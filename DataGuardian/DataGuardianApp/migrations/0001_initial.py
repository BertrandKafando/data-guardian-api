# Generated by Django 3.2.5 on 2023-11-20 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contraintes', models.ManyToManyField(blank=True, null=True, related_name='meta_colonne', to='DataGuardianApp.MetaTousContraintes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criteres', models.ManyToManyField(blank=True, null=True, related_name='diagnostics', to='DataGuardianApp.Critere')),
            ],
        ),
    ]
